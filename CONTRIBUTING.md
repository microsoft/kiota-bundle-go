# Contributing to the Kiota bundle for Go
...
The changelog is generated automatically from conventional commits as part of the release process. Do not update `CHANGELOG.md` in pull requests.
